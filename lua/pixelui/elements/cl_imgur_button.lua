...
function PANEL:SetImgurID(id)
    ...
    print("[PulsarUI UI] PulsarUI.ImgurButton:SetImgurID is deprecated, use PulsarUI.ImageButton:SetImageURL instead.")
    self.ImgurID = id
    self:SetImageURL("https://i.imgur.com/" .. id .. ".png")
end

function PANEL:GetImgurID()
    print("[PulsarUI UI] PulsarUI.ImgurButton:GetImgurID is deprecated, use PulsarUI.ImageButton:GetImgurID instead.")
...
function PANEL:SetImgurSize(size)
    ...
    print("[PulsarUI UI] PulsarUI.ImgurButton:SetImgurSize is deprecated, use PulsarUI.ImageButton:SetImageSize instead.")
    self.ImgurSize = size
    self:SetImageSize(size, size)
end

function PANEL:GetImgurSize()
    print("[PulsarUI UI] PulsarUI.ImgurButton:GetImgurSize is deprecated, use PulsarUI.ImageButton:GetImageSize instead.")
    return self:GetImageSize()
end

function PANEL:Init()
    print("[PulsarUI UI] PulsarUI.ImgurButton is deprecated, use PulsarUI.ImageButton instead.")
end
