...
PIXEL.RegisterFont("UI.ColorPickerNumberEntry", "Rubik", 14)
...
function PANEL:Init()
    ...
    self.RedEntry:SetFont("UI.ColorPickerNumberEntry", true)
    ...
    self.GreenEntry.TextEntry:SetFont("UI.ColorPickerNumberEntry", true)
    ...
    self.BlueEntry.TextEntry:SetFont("UI.ColorPickerNumberEntry", true)
    ...
    self.AlphaEntry.TextEntry:SetFont("UI.ColorPickerNumberEntry", true)
