...
function PIXEL.DrawFullOutlinedRoundedBox(borderSize, x, y, w, h, col, thickness)
    thickness = thickness or 1
    setDrawColor(col.r, col.g, col.b, col.a)
    ...
    PIXEL.DrawRoundedBox(borderSize - thickness, x + thickness, y + thickness, w - (thickness * 2), h - (thickness * 2), PIXEL.Colors.Background)
end