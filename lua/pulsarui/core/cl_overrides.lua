...
local overridePopupsCvar = CreateClientConVar("pulsar_ui_override_popups", (PulsarUI.OverrideDermaMenus > 1) and "1" or "0", true, false, "Should the default derma popups be restyled with PulsarUI?", 0, 1)
