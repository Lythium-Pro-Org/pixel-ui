...
function PANEL:Init()
    ...
    self.Switch = vgui.Create("PulsarUI.Switch", self.ScrollPanel)
    self.Switch:Dock(TOP)
    self.Switch:DockMargin(sc(50), sc(10), sc(50), sc(10))
    self.Switch:SetTall(PulsarUI.Scale(25))
    ...
    self.StepCounter:SetCurrentStep(4)
